# ChatGPT 中文版 ：国内最简单的ChatGPT镜像网站使用教程（支持GPT-4/4o，无需翻墙）【6月最新】
...
| [chat.lanjing.pro](https://chat.lanjing.pro)         | GPT 全系列模型, Claude, deepseek-r1,GPT-o3  | 有              | 国内邮箱支持        | ⭐⭐⭐⭐⭐    | 支持GPT-o1模型，一比一还原官网，可以使用实时语音对话        |
